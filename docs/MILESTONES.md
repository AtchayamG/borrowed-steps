...
2026-09-09: M2A/M2B accepted locally. M3 public hosting/release architecture is next; see M2B_INTEGRATION.md. No public release or submission acceptance yet.
...
| Equal-weight criterion | Product proof | Evidence |
|---|---|---|
| Technical | Real Strands tools and atomic persistence | Trace, race tests, deployed E2E |
| Design | Readiness/approvals/recovery coherent | Browser/keyboard/mobile walkthrough |
| Impact | Specific volunteer pain with measured outcome | Actual scenario measurements; no invented user feedback |
| Originality | Return-to-readiness and competing requests | Full workflow distinct from other two products |
| Presentation | English problem/audience/outcome and real actions | Public <=5-minute film, matching docs/diagram |

Official source: program OFFICIAL_RULES_VERIFICATION.md, snapshot 2026-09-07. Recheck live rules/form/updates at release and submission.
